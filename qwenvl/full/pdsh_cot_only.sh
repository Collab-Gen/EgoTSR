...
for i in "${!node_ips[@]}"; do
    ...
    pdsh -w $ip "cd /apdcephfs_gy2/share_302507476/xiaodayang/SpatialLogic/data && \
        ...
        accelerate launch --config_file $config_file --main_process_port $MASTER_PORT \
            /apdcephfs_gy2/share_302507476/xiaodayang/SpatialLogic/code/SpatialLogic/qwenvl/full/train_cot_only.py \
            --accelerate \
            --deepspeed $ds_config_file \
            --cot_files /apdcephfs_gy2/share_302507476/xiaodayang/SpatialLogic/data/json/Exp/cot50_new.json" &
done
