...
# 这些是默认值，可以通过命令行参数覆盖
DEFAULT_CONFIG = {
    "base_dir": "/apdcephfs_nj8/share_301739632/xiaodayang/data/SpatialLogic/LOVE-Agibot-Beta/General/data/images",  # 图片根目录
    ...
    "output_dir": "/apdcephfs_nj8/share_301739632/xiaodayang/data/SpatialLogic/LOVE-Agibot-Beta/ckpt_general",  # 输出ckpt目录
    "log_dir": "/apdcephfs_nj8/share_301739632/xiaodayang/code/SpatialLogic/full/log_general",  # TensorBoard 日志目录
