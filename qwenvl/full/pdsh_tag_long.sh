...
for i in "${!node_ips[@]}"; do
    ...
    pdsh -w $ip "
        ...
        accelerate launch --config_file $config_file --main_process_port $MASTER_PORT \
            /apdcephfs_nj8/share_301739632/xiaodayang/code/SpatialLogic/full/train_tag_long.py \
            --accelerate \
            ...
            --tag_files /apdcephfs_nj8/share_301739632/xiaodayang/data/SpatialLogic/LOVE-Agibot-Beta/tag_json/long_tag_step_total.json \
